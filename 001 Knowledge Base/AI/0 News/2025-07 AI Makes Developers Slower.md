...
- '[[2025-11-12 Gemini File Search RAG]]'
ai_generated: false
...
- It depends.
- Experience. We have to learn how to code anew. We'll pick up pace.
- Curiosity kills efficiency sometimes. But it alleviates over time.
- state of codebase
