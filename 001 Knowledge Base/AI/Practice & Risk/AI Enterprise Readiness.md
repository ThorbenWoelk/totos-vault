...
Whenever AI is tasked with doing parts of those background efforts by itself, the resulting application is usually too unreliable for important use cases.
