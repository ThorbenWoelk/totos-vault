...
- **Code**: 6B81
- **Essential Features**:
    - **Recurrent episodes of binge eating** (subjective loss of control often accompanied by eating notably larger or different amounts of food).
    - **Repeated inappropriate compensatory behaviors** to prevent weight gain (e.g., vomiting, laxatives, strenuous exercise).
    - **Preoccupation with body shape or weight** triggers self-evaluation.
    - Marked distress or significant impairment in functioning.
- **Key Differences from DSM-5**:
    - **Duration**: Symptoms persist for at least **1 month**, occurring at least once a week (DSM-5 requires 3 months).
    - **Binge Definition**: Explicitly allows for **"subjective" binges** (loss of control is the key feature, even if the amount of food is not objectively "large"), whereas DSM-5 emphasizes an "objectively large" amount.
